...
class EvidenceTests(unittest.TestCase):
    ...
    def put(self,table,day='20260904',observed='2026-09-04T16:00:00+08:00',source=None,**values):
        ...
        default_source='tushare.moneyflow_ths@dailyfetch' if table=='moneyflow' else next(iter(SOURCES[table]))
        self.db.execute('INSERT INTO '+table+' VALUES(NULL,?,?,?,?,?,?,?)',('600000.SH',source or default_source,day,observed,day[:4]+'-'+day[4:6]+'-'+day[6:]+'T15:00:00+08:00',1,json.dumps(payload)))
        self.db.commit()
