...
SOURCES = {
    ...
    'moneyflow': {'tushare.moneyflow_ths@dailyfetch','tushare.moneyflow@dailyfetch'},
}
    ...
    with closing(sqlite3.connect(Path(path).resolve().as_uri()+'?mode=ro', uri=True, timeout=1)) as db:
        ...
        for table in SOURCES:
            ...
            if table=='stock_daily':
                ...
                field='net_amount' if latest['source']=='tushare.moneyflow_ths@dailyfetch' else 'net_mf_amount'
